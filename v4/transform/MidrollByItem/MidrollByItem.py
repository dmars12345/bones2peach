...
unmapped_overlay_cappacity_pages = unmapped_overlay_cappacity_paginator.paginate( Bucket='freewheel-v4-log-bucket',Prefix=f"transform/filteredMidroll/{today}/json/")
per = []
agg = []
...
my_s3_resource.Object('freewheel-v4-log-bucket', f"transform/filteredMidroll/{str(today)}/mapped/series.json").put(Body=json.dumps(series_output))
...
my_s3_resource.Object('freewheel-v4-log-bucket', f"transform/filteredMidroll/{str(today)}/mapped/Site.json").put(Body=json.dumps(Site_output))
...
my_s3_resource.Object('freewheel-v4-log-bucket', f"transform/filteredMidroll/{str(today)}/mapped/SiteSection.json").put(Body=json.dumps(SiteSection_output))
...
my_s3_resource.Object('freewheel-v4-log-bucket', f"transform/filteredMidroll/{str(today)}/mapped/PlatformDevice.json").put(Body=json.dumps(PlatformDevice_output))